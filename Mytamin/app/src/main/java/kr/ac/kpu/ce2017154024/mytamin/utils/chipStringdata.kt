...
object chipStringdata {
    ...
    val verysad= arrayOf<String>("지치는","무서운","혼란스러운","화나는","자책하는","상처받은","실망한","역겨운","끔찍한","수치스러운","미어지는","우울한","서러운","죄스러운")
    ...
    val category = arrayOf("이루어 낸 일","잘한 일이나 행동","노력하고 있는 부분","긍정적인 변화나 깨달음","감정, 생각 혹은 신체 일부분","과거의 나","기타")
