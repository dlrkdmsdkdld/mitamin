...
class SingleSelectWishAdapter(WishlistRecyclerview: IWishRecyclerAdapter,idArray:List<WishList>)  : RecyclerView.Adapter<WishlistRecyclerViewHolder>(){
    ...
    override fun onBindViewHolder(holder: WishlistRecyclerViewHolder, position: Int) {
        ...
        Log.d(Constant.TAG,"select position")
